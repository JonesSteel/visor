...
-->
	<!--fontawesome icons-->
	<script src="https://kit.fontawesome.com/1bde731729.js" crossorigin="anonymous"></script>
...
<body style="height: 100vh; overflow: auto;">
	...
	<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
		...
		<p class="lead">
			...
			&nbsp; <i style="font-size:20px;color:#235B4E;">/ &nbsp;<b> Acciones Sociales 2022</b></i>
		</p>
					...
					<div class="card-deck mb-3 text-center">
						<div class="card mb-4 box-shadow">
							<div class="card-header">
								<h4 class="my-0 font-weight-normal">Cambio de semáforo 2022</h4>
							</div>
							<div class="card-body">
								<p style="text-align: justify">Aplicación que nos permite consultar la información relacionada con la <strong> estrategia de cambio de semáforo rojo 2022.</strong></p>
								<br>
								<br>
								<button onclick="location.href='http://<?php echo $url ?>/visor/Visores/preregistro'" class="btn btn-primary btn-block">Seleccionar</button>
							</div>
						</div>
						<div class="col-md-4">
