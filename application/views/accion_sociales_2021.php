...
<body style="height: 100vh; overflow: auto;">
	...
	<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
		...
		<p class="lead">
			...
			&nbsp; <i style="font-size:20px;color:#235B4E;">/ &nbsp;<b> Acciones Sociales 2021</b></i>
		</p>
		<div class="container">´
					...
					<div class="card-deck mb-3 text-center">
						<div class="card mb-4 box-shadow">
							<div class="card-header">
								<h4 class="my-0 font-weight-normal" style="font-size: 22px;">Velódromo (Regularización 2021)</h4>
							</div>
							<div class="card-body">
								...
								<br><br>
								<button onclick="location.href='http://<?php echo $url ?>/visor/Visores/velodromo_regularizacion'" class="btn btn-primary btn-block">Seleccionar</button>
							</div>
						</div>
