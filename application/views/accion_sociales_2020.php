...
<body style="height: 100vh; overflow: auto;">
	...
	<div class="prici ng-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
		<p style="text-align: center"><strong>Módulos de Consulta Rápida</strong> | DGRPT</p>
		<p class="lead">
			<a href="<?php echo base_url(); ?>Visores">
				<i class='fas fa-home'></i> Regresar a Principal </i>
			</a>
			&nbsp; <i style="font-size:20px;color:#235B4E;">/ &nbsp;<b> Acciones Sociales 2020</b></i>
		</p>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="card-deck mb-3 text-center">
						<div class="card mb-4 box-shadow">
							<div class="card-header">
								<h4 class="my-0 font-weight-normal">Cuautepec Fase 1</h4>
							</div>
							<div class="card-body">
								<p style="text-align: justify">Aplicación que nos permite consultar los documentos con los que cuenta cada concesión de Taxi que entro al <strong>programa de sustitución 2020.</strong></p>
								<br>
								<button onclick="location.href='<?php echo base_url(); ?>Visores/sin_informacion'" class="btn btn-primary btn-block">Seleccionar</button>
							</div>
						</div>
						<div class="card mb-4 box-shadow">
							<div class="card-header">
								<h4 class="my-0 font-weight-normal">Mano Alzada Fase 1</h4>
							</div>
							<div class="card-body">
								<p style="text-align: justify">Aplicación que nos permite consultar los documentos con los que cuenta cada concesión de Ruta que entro al <strong>programa de regularización.</strong></p>
								<br>
								<button onclick="location.href='<?php echo base_url(); ?>Visores/sin_informacion'" class="btn btn-primary btn-block">Seleccionar</button>
							</div>
						</div>
