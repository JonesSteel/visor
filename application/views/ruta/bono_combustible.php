            ...
            $(document).ready(function() {
                ...
                */
                var peritaje_provional_titulos_convenios = $('#peritaje-provional-titulos-convenios').DataTable({
                    ...
                    "bProcessing": true,
                    "sAjaxSource": "<?php echo base_url('Read_data/ss_preregistro_velodromo'); ?>",
                    "bPaginate": true,
                    "iDisplayLength": 10,
                    "aoColumns": [{
                            mData: "placa"
                ...
                */
                ...
                $(document).on("click", ".btn-preregistro", function() {

                    contentModalExpediente(
                        "<?php echo base_url('Read_data/content_preregistro/'); ?>",
                        "<b>Pre-registro de la concesión ",
                        $(this).closest("tr").find('td:eq(0)').text().replace(/_\d+$/gi,"")
                    );

                });

                $(document).on("click", ".btn-velodromo", function() {

                    contentModalExpediente(
                        "<?php echo base_url('Read_data/content_velodromo/'); ?>",
                        "<b>Regularización de la concesión ",
