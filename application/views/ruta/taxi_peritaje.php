...
<body style="height: 100vh; overflow: auto;">
	...
	<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
		...
		<p class="lead">
			...
			&nbsp;
			<a href="http://<?php echo $url ?>/visor/Visores/acciones_2021">
			<i style="font-size:20px;color:#2f6997;">/ &nbsp;<b> Acciones Sociales 2021</b></i>
			</a>
			&nbsp; <i style="font-size:20px;color:#235B4E;">/ &nbsp;<b> Taxi Sustitución 2021: Peritaje </b></i>
		</p>
		...
		<div class="container">
			<div id="container">
				...
				<div id="body">
						...
						<div id="body">
							<iframe width="1200" height="1100" src="http://<?php echo $url ?>/visualizador-taxi/peritaje.php/" frameborder="0">
							<!--	<iframe width="100%" height="1100" src="http://localhost/visualizador-taxi/peritaje.php">-->
							</iframe>
